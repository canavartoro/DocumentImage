...
namespace DocumentImageCapture
{
    static class XPOHelper
    {
        public static void XPOStart()
        {
            try
            {
                string conString = SQLiteConnectionProvider.GetConnectionString(string.Format("{0}\\{1}_images.dat", System.Windows.Forms.Application.StartupPath, DateTime.Now.Year));
                ...
                XpoDefault.Session = new DevExpress.Xpo.Session(XpoDefault.DataLayer);
